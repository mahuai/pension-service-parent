package com.lingyue.usercenter.feign.config.filesvc;
 ...
 * FormData encoder
 * 参考资料：https://github.com/pcan/feign-client-test
 *
 * @author zhanghengrui
 * @date 2022/5/12
 */
public class FeignSpringFormEncoder implements Encoder {
    ...
    public static final String ENCODING_ERROR_TIP = "无法对请求进行编码:";
     ...
     * @param template
     */
    private void encodeMultipartFormRequest(Map<Object, ?> formMap, HttpHeaders multipartHeaders,
    ...
    private void encodeRequest(Object value, HttpHeaders requestHeaders, RequestTemplate template) {
        ...
        try {
            ...
            throw new EncodeException(ENCODING_ERROR_TIP, e);
        }
         ...
         */
        /*
          使用feign-httpclient时，指定Charset后，下游收到的流会被篡改
          参考openfeign的issue [https://github.com/OpenFeign/feign-form/issues/18] 问题一致
          社区已修复,具体代码是这次commit[ https://github.com/OpenFeign/feign-form/commit/dfed8c65a78cf1c70d07e60123f32db372a9b38e ]
          另外，outputStream是ByteArrayOutputStream，并非字符流，不需要处理字符集
         */
     ...
     */
    private void encodeMultipartFiles(LinkedMultiValueMap<Object, Object> map, String name,
                                      List<? extends MultipartFile> fileList) {
        HttpHeaders filePartHeaders = new HttpHeaders();
        //设置 Content-type
        filePartHeaders.setContentType(MediaType.APPLICATION_OCTET_STREAM);
        try {
            for (MultipartFile file : fileList) {
                Resource multipartFileResource = new MultipartFileResource(file.getInputStream(),
